                ...
                if (_Meter > _ZoneClassPoints[_i] && !_ZonePoints[_i])
                {
                    switch (_ZoneClassPoints[_i])
                    {
                        ...
                        case 11000:
                            ...
                            switch (MenuSystem._Instance._Index_Vehicle)
                            {
                                case 0:
                                    GameServices.UnlockAchievement(EM_GameServicesConstants.Achievement_burger_arrived);
                                    break;
                                case 1:
                                    GameServices.UnlockAchievement(EM_GameServicesConstants.Achievement_torpedo_arrived);
                                    break;
                                case 2:
                                    GameServices.UnlockAchievement(EM_GameServicesConstants.Achievement_tidal_arrived);
                                    break;
                                case 3:
                                    GameServices.UnlockAchievement(EM_GameServicesConstants.Achievement_fishkenstein_arrived);
                                    break;
                            }
                            break;
                        default:
